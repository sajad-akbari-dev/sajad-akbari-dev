...
const sajad = {
  ...
  currentFocus: ["Cloud Computing", "DevOps", "Full-Stack Development"],
  learning: [
...
| --------------------------------- | ----------------------------------------------------------- | ---------------------------------- |
| **[Portfolio Website](https://sajad-portfolio-gamma.vercel.app/)**        | Responsive personal portfolio showcasing my work and skills | TailwindCSS, Alpine.js, JavaScript |
...
<table align="center">
  <tr>
    <td align="center" width="33%">
      ...
      <br><strong>AWS Certification</strong>
    ...
    <td align="center" width="33%">
      ...
      <br><strong>DevOps Mastery</strong>
